...
class DecoratedSpaceTest(LoggedTestCase):
    ...
    def test_Discrete(self):
        ...
        self.assertEquals(2, space.get(2))
    ...
    def test_Dict(self):
        ...
        space.get(8)  # smoke test 
        self.assertEquals({'a':3, 'b':1}, space.get(8))
    ...
    def test_MultiBinary(self):
        ...
        self.assertEquals([0, 1, 0, 1, 1, 0, 1], list(space.get(64 + 16 + 8 + 2)))
